<template>
  <div>
    <div
      ...
      class="absolute left-4 top-4 -ml-px mt-0.5 h-full w-0.5 bg-blue-600"
      aria-hidden="true"
    />
    <div
      :class="[
        'group relative flex items-center',
        { 'items-start': trackedAt },
      ]"
    >
      <span
        class="flex h-[70px] w-8 shrink-0 items-center justify-center"
        aria-hidden="true"
      >
        <span
          class="relative z-10 flex h-3 w-3 items-center justify-center rounded-full bg-blue-600 group-hover:bg-blue-800"
        >
          <span
